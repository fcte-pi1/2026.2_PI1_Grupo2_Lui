...
<u>RF01/HU01: Transmitir telemetria em tempo real</u>

| ID (Link Github Projects) | Título | Prioridade |
| :------------------------ | :----- | :--------- |
| [HU01](#) | Transmitir telemetria em tempo real | Alta |

**Critérios de Aceitação:**
1. O robô deve conectar-se via Wi-Fi ao sistema web.
2. A atualização dos dados (velocidade, bateria, trajeto) deve ocorrer em tempo real (delay < 500ms).
3. O sistema deve indicar caso a conexão com o robô seja perdida.

[Protótipo de baixa 1](https://excalidraw.com/#json=EwixAvoRnMQKEk-CD8BSF,Pl98Af1v61ccvHXETz4NVA)

<u>RF02/HU02: Consultar histórico de corridas</u>

| ID (Link Github Projects) | Título | Prioridade |
| :------------------------ | :----- | :--------- |
| [HU02](#) | Consultar histórico de corridas | Média |

**Critérios de Aceitação:**
1. O sistema deve exibir uma lista de todas as corridas salvas.
2. O usuário deve conseguir filtrar corridas por tamanho do labirinto (4x4, 8x4, 12x4).
3. Ao clicar em uma corrida, os dados detalhados da telemetria e o trajeto completo devem ser exibidos.


[Protótipo de baixa 1](https://excalidraw.com/#json=EwixAvoRnMQKEk-CD8BSF,Pl98Af1v61ccvHXETz4NVA)

<u>RF03/HU03: Identificar e exibir o tamanho do labirinto atual</u>

| ID (Link Github Projects) | Título | Prioridade |
| :------------------------ | :----- | :--------- |
| [HU03](#) | Identificar e exibir o tamanho do labirinto atual | Alta |

**Critérios de Aceitação:**
1. O sistema web deve receber do robô o tamanho estimado ou configurado do labirinto atual.
2. O dashboard deve exibir visualmente a grade do labirinto de acordo com o tamanho selecionado (4x4, 8x4, 12x4).
3. A interface gráfica deve se adaptar sem distorcer o trajeto.
...
| :------------------------ | :----- | :--------- | :-------------- |
| [RNF01](#) | Restrição física de movimentação (solo) | Alta | - |
| [RNF02](#) | Identificação de cores no ambiente | Alta | - |
| [RNF03](#) | Operação em dimensões oficiais | Alta | - |
| [RNF04](#) | Gerenciamento em GitHub e GitHub Projects | Média | - |
| [RNF05](#) | Originalidade da solução (sem plágio) | Alta | - |
